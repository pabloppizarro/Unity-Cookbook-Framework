...
public class Waypoints_Controller : MonoBehaviour
{
    ...
    // arraylist for easy access to // transforms
    private Vector3 firstPoint;
    // store our first waypoint so we can // loop the path
    ...
    public void GetTransforms()
    {
        ...
        // which is initialised here (we always need to do this // before we can use ArrayLists)
    ...
    public int FindNearestWaypoint(Vector3 fromPos, float maxRange)
    {
        ...
        for (int i = 0; i < transforms.Count; i++)
        {
            ...
            // now compare distances - making sure that // we are not closer than the closest object
